    ...
    private fun getValidKeysetHandle(context: Context, keysetName: String, template: com.google.crypto.tink.KeyTemplate): KeysetHandle {
        return try {
            AndroidKeysetManager.Builder()
                .withSharedPref(context, keysetName, Constant.PREF_FILE_NAME)
            ...
            context.getSharedPreferences(Constant.PREF_FILE_NAME, Context.MODE_PRIVATE).edit().clear().apply()
    ...
    fun encryptMessage(
        ...
        try {
            ...
            val signKeysetHandle = AndroidKeysetManager.Builder()
                .withSharedPref(context, Constant.SIGN_KEYSET_NAME, Constant.PREF_FILE_NAME)
                .withMasterKeyUri(Constant.MASTER_KEY_URI)
                .build()
                .keysetHandle
